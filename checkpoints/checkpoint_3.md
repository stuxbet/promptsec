...
- Prompt separation and source labeling
- Tool allowlist with blocked unsupported actions
- Output validators for leakage and hijack indicators
- Simulated approval gate for high-risk drafts
